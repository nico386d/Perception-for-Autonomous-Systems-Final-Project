...
# Classes we keep and their numeric IDs
...
def build_sequence_samples(raw_root: Path, rect_root: Path, seq_name: str, camera: str = "image_02"):
    """
    Build samples from a DTU sequence (seq_01, seq_02, seq_03) using:
      - labels from 34759_final_project_raw
      - rectified images from 34759_final_project_rect

    Label format is KITTI tracking style:
    frame_id, track_id, class, trunc, occ, alpha, x1, y1, x2, y2, ...
    """
    ...
    with open(labels_path) as f:
        for line in f:
            ...
            frame_idx = int(parts[0])       # 0..144, 0..208, ...
            cls = parts[2]                  # "Pedestrian", "Cyclist", "Car"
            ...
            # In tracking format: x1,y1,x2,y2 are at indices 6,7,8,9
